...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
    ...
    <div class="w3-container w3-padding-32 w3-center">
        <div class="w3-center w3-padding-32">
            <div class="w3-bar">
                ...
                <a href="<spring:url value="/panel/panelAdmin"/>" class="w3-bar-item w3-black w3-button"><spring:message code="panel.panelAdmin.title"/></a>
            ...
            <div class="thumbnail">
                <div class="w3-display-container">
                    <a href="<spring:url value="/products/add"/>">
                        <img src="<c:url value="/resources/images/newDish.png"></c:url>" alt="image" style="width:100%"/>
                        <span class="w3-tag w3-display-topleft">
                            <h3><spring:message code="panel.panelAdmin.add"/></h3>
                        </span>
                    </a>
                </div>
            </div>
            ...
            <div class="thumbnail">
                <div class="w3-display-container">
                    <a href="<spring:url value="/panel/panelProducts"/>">
                        <img src="<c:url value="/resources/images/deleteDish.png"></c:url>" alt="image" style="width:100%"/>
                        <span class="w3-tag w3-display-topleft">
                            <h3><spring:message code="panel.panelAdmin.delete"/></h3>
                        </span>
                    </a>
                </div>
            </div>
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
        <div class="w3-half">
            <div class="thumbnail">
                <div class="w3-display-container">
                    <a href="<spring:url value="/panel/panelProductsEdit"/>">
                        <img src="<c:url value="/resources/images/editDish.png"></c:url>" alt="image" style="width:100%"/>
                        <span class="w3-tag w3-display-topleft">
                            <h3><spring:message code="panel.panelAdmin.edit"/></h3>
                        </span>
                    </a>
                </div>
            </div>
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
        <div class="w3-half">
            <div class="thumbnail">
                <div class="w3-display-container">
                    <a href="<spring:url value="/mail"/>">
                        <img src="<c:url value="/resources/images/sendMail.png"></c:url>" alt="image" style="width:100%"/>
                        <span class="w3-tag w3-display-topleft">
                            <h3><spring:message code="panel.panelAdmin.send"/></h3>
                        </span>
                    </a>
                </div>
            </div>
