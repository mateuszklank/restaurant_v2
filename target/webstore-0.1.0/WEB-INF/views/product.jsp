...
<html>
	...
	<head>
		...
		<script src="<c:url value="/resources/javascript/controllers.js" />"></script>
	</head>
						...
						<div class="w3-quarter">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<p><b>Kategoria</b><br>${product.category}</p>
									<p><b>Kod produktu</b><br>${product.productId}</p>
								</div>
							</div>
						</div>
						<div class="w3-quarter">
							...
							<div class="thumbnail">
								<div class="w3-center w3-padding-32">
									<div class="w3-bar">
										<a href="<spring:url value="/products"/>" class="w3-bar-item w3-black w3-button" ngclick="addToCart('${product.productId}')">
											<p ng-controller="cartCtrl"><spring:message code="product.order"/></p>
										</a>
										<a href="<spring:url value="/cart/"/>" class="btn btn-default">
											<span class="glyphicon-hand-right glyphicon"></span> Koszyk
										</a>
