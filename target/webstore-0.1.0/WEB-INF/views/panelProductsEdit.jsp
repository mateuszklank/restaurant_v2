...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
    ...
    <div class="w3-container w3-padding-32 w3-center">
        <div class="w3-padding-32">
            <h4><b><spring:message code="panel.panelProductsEdit.title"/></b></h4>
            <hr>
            <p><spring:message code="panel.panelProductsEdit.about"/></p>
            <hr>
        </div>
    </div>
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
        <c:forEach items="${panelProductsEdit}" var="product">
            <div class="w3-third">
                <div class="thumbnail">
                    <img src="<c:url value="/resources/images/${product.productId}.png"></c:url>" alt="image" style="width:50%"/>
                    <div class="caption">
                        <h3>${product.name}</h3>
                            <%--
                            ...
                            --%>
                        <p>
                            <a href="<spring:url value="/products/edit?id=${product.productId}"/>" class="btn btn-primary">
                                <span class="glyphicon-info-sign glyphicon"/></span>
                                <spring:message code="panel.panelProductsEdit.edit"/>
                            </a>
                        </p>
                    </div>
                </div>
