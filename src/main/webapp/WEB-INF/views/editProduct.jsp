...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
    ...
    <div class="w3-container w3-padding-32 w3-center">
        <div class="w3-padding-32">
            <h4><b><spring:message code="editProduct.form.title.label"/></b></h4>
            <hr>
            <p><spring:message code="editProduct.form.description.label"/></p>
            <hr>
        </div>
    </div>

    <form:form modelAttribute="editProduct" class="w3-container" enctype="multipart/form-data">
        <div class="w3-container w3-black">
            <h4><spring:message code="editProduct.form.newdish.label"/></h4>
        </div>
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form:input id="productId" path="productId" type="text" class="w3-input" value="${product.productId}"/>
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form:input id="name" path="name" type="text" class="w3-input" value="${product.name}"/>
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form:input id="unitPrice" path="unitPrice" type="text" class="w3-input" value="${product.unitPrice}"/>
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form:input id="category" path="category" type="text" class="w3-input" value="${product.category}"/>
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form:textarea id="description" path="description" rows="4" cols="151" value="${product.description}"/>
                </div>
            </div>
        </fieldset>
        <br>
        ...
        <div class="w3-container w3-black">
            <h4>
                <spring:message code="editProduct.form.productAdd.label" var="adding"/>
