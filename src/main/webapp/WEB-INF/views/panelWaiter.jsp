    ...
    <div class="w3-container w3-padding-32 w3-center">
        <div class="w3-center w3-padding-32">
            <div class="w3-bar">
                ...
                <a href="<spring:url value="/panel/panelWaiter"/>" class="w3-bar-item w3-black w3-button"><spring:message code="panel.panelWaiter.title"/></a>
                ...
                <div class="w3-display-container">
                    <a href="<spring:url value="/products"/>">
                        ...
                        <span class="w3-tag w3-display-topleft">
                            <h3><spring:message code="panel.panelWaiter.makeOrder"/></h3>
                        </span>
                    </a>
                </div>
            </div>
