...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
    ...
    <div class="w3-container w3-padding-32 w3-center">
        <div class="w3-padding-32">
            <h4><spring:message code="panel.panelAdmin.mailTitle"/></h4>
        </div>
    </div>
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
        ...
        <div class="w3-half">
            <div class="thumbnail">
                <div class="w3-display-container">
                    <a href="<spring:url value="/mail/sendTemplate"/>">
                        <img src="<c:url value="/resources/images/special.png"></c:url>" alt="image" style="width:100%"/>
                        <span class="w3-tag w3-display-topleft">
                            <h3><spring:message code="panel.panelAdmin.sendSpecial"/></h3>
                        </span>
                    </a>
                </div>
            </div>
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
        <div class="w3-half">
            <div class="thumbnail">
                <div class="w3-display-container">
                    <a href="<spring:url value="/mail/sendAttachment"/>">
                        <img src="<c:url value="/resources/images/attachment.png"></c:url>" alt="image" style="width:100%"/>
                        <span class="w3-tag w3-display-topleft">
                            <h3><spring:message code="panel.panelAdmin.sendAttachment"/></h3>
                        </span>
                    </a>
                </div>
            </div>
