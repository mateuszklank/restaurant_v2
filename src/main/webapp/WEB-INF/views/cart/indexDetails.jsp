...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
    ...
    <div class="w3-container w3-padding-32 w3-center">
        ...
        <form:form modelAttribute="newCustomer" class="w3-container" enctype="multipart/form-data">
            <div class="w3-container w3-black">
                <h4><spring:message code="cart.form.title"/></h4>
            </div>
            ...
            <fieldset>
                <div class="form-group">
                    <label class="control-label col-lg-2 col-lg-2" for="name">
                        <spring:message code="cart.form.name"/>
                    </label>
                    <div class="col-lg-10">
            ...
            <fieldset>
                <div class="form-group">
                    <label class="control-label col-lg-2 col-lg-2" for="surname">
                        <spring:message code="cart.form.surname"/>
                    </label>
                    <div class="col-lg-10">
                        <form:input id="surname" path="surname" type="text" class="w3-input"/>
            ...
            <fieldset>
                <div class="form-group">
                    <label class="control-label col-lg-2 col-lg-2" for="email">
                        <spring:message code="cart.form.email"/>
                    </label>
                    <div class="col-lg-10">
                        <form:input id="email" path="email" type="text" class="w3-input"/>
            ...
            <fieldset>
                <div class="form-group">
                    <label class="control-label col-lg-2 col-lg-2" for="street">
                        <spring:message code="cart.form.street"/>
                    </label>
                    <div class="col-lg-10">
                        <form:input id="street" path="street" type="text" class="w3-input"/>
                        <form:errors path="street" cssClass="alert"/>
                    </div>
                </div>
            </fieldset>
            <br>
            <fieldset>
                <div class="form-group">
                    <label class="control-label col-lg-2 col-lg-2" for="address">
                        <spring:message code="cart.form.address"/>
                    </label>
                    <div class="col-lg-10">
                        <form:input id="address" path="address" type="text" class="w3-input"/>
            ...
            <div class="w3-container w3-black">
                <h4>
                    <spring:message code="product.order" var="adding"/>
